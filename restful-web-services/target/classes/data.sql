insert into user_details(id,birth_date,name) values(10001,current_date(),'Goutam');
insert into user_details(id,birth_date,name) values(10002,current_date(),'Anil');
