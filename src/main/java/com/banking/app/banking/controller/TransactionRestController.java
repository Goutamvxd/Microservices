...
import com.banking.app.banking.services.AccountService;
import com.banking.app.banking.services.TransactionService;
import com.banking.app.banking.utils.DepositInput;
import com.banking.app.banking.utils.InputValidator;
import com.banking.app.banking.utils.TransactionInput;
import com.banking.app.banking.utils.WithdrawInput;
...
public class TransactionRestController {
	...
	private static final String INSUFFICIENT_ACCOUNT_BALANCE = "Insufficient account balance";
	...
	public ResponseEntity<?> withdraw(@Valid @RequestBody WithdrawInput withdrawInput) {
		...
		if (InputValidator.isSearchCriteriaValid(withdrawInput)) {
			...
			if (account == null) {
				...
				if (transactionService.isAmountAvailble(withdrawInput.getAmount(), account.getCurrentBalance())) {
